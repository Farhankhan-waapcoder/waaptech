  ...
  return (
    <main>
      ...
      <section className="container mx-auto py-12 md:py-16">
        <h1 className="font-heading text-3xl md:text-4xl">AI-Enabled Services</h1>
      ...
      <section className="container mx-auto grid gap-8 sm:grid-cols-2 lg:grid-cols-3 pb-12">
        {services.map((svc) => (
